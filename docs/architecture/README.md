...
| [Scene rendering](../../src/maya/core/scene.cpp), [shader](../../resources/shaders/metal/triangle.metal) | Direct draws reuse one uniform region; normals use the model's upper 3x3. | #996 explicit passes and #997 per-draw upload memory (done); #998 extraction and correct normal transforms. Nonuniform-scale lighting is not yet correct. |
